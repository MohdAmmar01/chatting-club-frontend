        ...
        <>
            <div className="login">
                <form className="login-form">
                    ...
                    <h4 style={{ 'color': 'white', 'fontFamily': 'cursive','textAlign': 'center' }} className='r-h'> Dont have an account ?<Link to='/register' style={{ 'color': 'white', 'textDecoration': 'none' }}> Register</Link ></h4>
                </form>
            </div>
            <ToastContainer />
